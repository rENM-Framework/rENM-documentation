...
![rENM](https://img.shields.io/badge/rENM-framework-blue) ![module](https://img.shields.io/badge/module-documentation-informational) ![status](https://img.shields.io/badge/status-pre--release-orange)

**User manual and reference documentation for the rENM Framework**

## Overview

This repository contains the primary documentation for the rENM Framework — a modular suite of R packages for reconstructing and analyzing long-term ecological niche dynamics using historical species occurrence records and environmental data.
...
| File                               | Description           |
|------------------------------------|-----------------------|
| `rENM-Framework-User-Manual.qmd`   | Quarto source         |
| `rENM-Framework-User-Manual.pdf`   | PDF                   |
| `rENM-Framework-User-Manual.docx`  | Word                  |
| `rENM-Framework-User-Manual.html`  | HTML (self-contained) |
| `rENM-Framework-User-Manual.ipynb` | Jupyter notebook      |

### Reference Manuals

Generated from the installed packages via `R CMD Rd2pdf`. Install the packages and run `?<function>` in R for interactive function-level help.

| File                           | Description                    |
|--------------------------------|--------------------------------|
| `rENM.core_0.1.0.9000.pdf`     | rENM.core reference manual     |
| `rENM.data_0.1.0.9000.pdf`     | rENM.data reference manual     |
| `rENM.model_0.1.0.9000.pdf`    | rENM.model reference manual    |
| `rENM.analysis_0.1.0.9000.pdf` | rENM.analysis reference manual |
| `rENM.ai_0.1.0.9000.pdf`       | rENM.ai reference manual       |
| `rENM.reports_0.1.0.9000.pdf`  | rENM.reports reference manual  |

## The rENM Framework

The rENM Framework spans six modular R packages organized as a linear analytical pipeline:

```         
rENM.core → rENM.data → rENM.model → rENM.analysis → rENM.ai → rENM.reports
```

Each package has its own GitHub repository and README under the [rENM-Framework](https://github.com/rENM-Framework) organization.
...
> **Pre-release.** Content is subject to ongoing revision and periodic updates.
